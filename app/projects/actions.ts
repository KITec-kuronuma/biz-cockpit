...
const projectSchema = z
  .object({
    ...
    undatedForecast: z.coerce.number().int().min(0).default(0),
    forecastTiming: z.enum(["UNDECIDED", "THIS_FY", "NEXT_FY"]).default("UNDECIDED"),
...
function buildData(d: z.infer<typeof projectSchema>) {
  ...
  return {
    ...
    undatedForecast: d.undatedForecast ?? 0,
    forecastTiming: d.forecastTiming ?? "UNDECIDED",
